...
// fonte de dados como listagem, busca, criação, edição, remoção
...
class AppointmentsRepository implements IAppointmentsRepository {
  ...
  // o resto é uma promise
  // findOne é um metodo do repository do typeorm
  // que verificar date é igual a data passada dentro do banco
